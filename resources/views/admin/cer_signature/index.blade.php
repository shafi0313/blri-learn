...
@section('content')
@php $m='frontend'; $sm='cerSignature'; $ssm=''; @endphp
        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">Certificate Signature</li>
                </ul>
            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{ route('certificate-signature.create') }}" class="btn btn-{{$layout->create_btn??'primary'}} btn-round ml-auto text-light" style="min-width: 200px">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="multi-filter-select" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        @php $x = 1 @endphp
                                        @foreach ($cerSignatures as $cerSignature)
                                        <tr>
