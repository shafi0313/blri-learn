                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="course_cat_id">Course Categories <span
                                                        class="t_r">*</span></label>
                                                <select name="course_cat_id" class="form-control">
                                                    <option value="">Select</option>
                                                    @foreach ($courseCats as $courseCat)
                                                        <option value="{{ $courseCat->id }}" @selected(old('course_cat_id') == $courseCat->id)>
                                                            {{ $courseCat->name }}</option>
                                                    @endforeach
                                                </select>
                                                @if ($errors->has('course_cat_id'))
                                                    <div class="alert alert-danger">{{ $errors->first('course_cat_id') }}
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="skill_level" class="form-control"
                                                    value="{{ old('skill_level') }}" placeholder="Enter skill level"
                                                    required>
                                                @if ($errors->has('skill_level'))
                                                    <div class="alert alert-danger">{{ $errors->first('skill_level') }}
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="status"
                                                    title="When all lectures are uploaded then edit this course and select completed and click on the update button">Status</label>
                                                <select class="form-control" name="status"
                                                    title="When all lectures are uploaded then edit this course and select completed and click on the update button">
                                                    <option selected value disabled>Select</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="video_dis">Video Description <span class="t_r">Put youtube
                                                        iframe code</span></label>
                                                <input type="text" name="video_dis" class="form-control"
                                                    value="{{ old('video_dis') }}" placeholder="Enter Video Description">
