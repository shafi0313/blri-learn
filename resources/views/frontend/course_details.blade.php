...
@section('content')
    ...
    @php
        $star5 = $coursesReviews
            ...
            ->where('ratings', '=', 5)
            ->count();
        $star4 = $coursesReviews
            ->where('course_id', $course->id)
            ->where('ratings', '=', 4)
            ->count();
        $star3 = $coursesReviews
            ->where('course_id', $course->id)
            ->where('ratings', '=', 3)
            ->count();
        $star2 = $coursesReviews
            ->where('course_id', $course->id)
            ->where('ratings', '=', 2)
            ->count();
        $star1 = $coursesReviews
            ->where('course_id', $course->id)
            ->where('ratings', '=', 1)
            ->count();
                ...
                <div class="col-md-7 col-xl-8">
                    ...
                    <ul class="list-unstyled d-flex flex-wrap mb-4">
                        <li class="course-d-Teacher me-3 me-lg-5 mb-2 mb-lg-0">
                            <div class="d-flex">
                                <img class="me-2 me-lg-3 mt-2" src="{{ profileImg() }}" alt="">
                                <div class="d-block">
                        ...
                        <li class="me-3 me-lg-5 mb-2 mb-lg-0">
                            <div class="d-flex">
                                ...
                                <div class="d-block">
                                    ...
                                    <span class="lead fw-6 text-dark">{{ $course->enrollCounts->count() }}
                                        (Registered)</span>
                                </div>
                            </div>
                        </li>
                            ...
                            <form action="{{ route('course-review.store') }}" method="post" class="form-flat-style">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3 col-lg-4">
                                        ...
                                        <input type="text" name="subject" class="form-control" id="phone"
                                            placeholder="Subject">
                                    ...
                                    <div class="form-group mb-3 col-lg-12">
                                        ...
                                        <textarea class="form-control" name="msg" rows="4" placeholder="Your message"></textarea>
                                        @if ($errors->has('msg'))
                                ...
                                @auth
                                    ...
                                    @else
                                        <a class="btn btn-primary"
                                            href="{{ route('user.lecture.show', $course->id) }}">View</a>
                                    @endif
                                @endauth
                                @guest
                                ...
                                <div class="modal-content">
                                    <div class="modal-header border-0">
                                        <h5 class="modal-title" id="loginModalLabel">
                                            {{ __('login_register.loginRegister') }}</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <ul class="nav nav-tabs nav-tabs-02 justify-content-center" id="myTab"
                                            role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="login-tab" data-bs-toggle="tab"
                                                    href="#loginC" role="tab" aria-controls="login"
                                                ...
                                                <form action="{{ route('enrollRegisterStore') }}" method="post"
                                                    ...
                                                    <div class="mb-3 col-sm-12">
                                                        <select name="gender" class="form-control" required>
                                                            <option value="">{{ __('login_register.gender') }} *
                                                            </option>
                                                            <option value="1">{{ __('login_register.male') }}
                                                            </option>
                                                            <option value="2">{{ __('login_register.female') }}
                                                            </option>
                                                            <option value="3">{{ __('login_register.other') }}
                                                            </option>
                                                        </select>
                                                    ...
                                                    <div class="mb-3 col-sm-12 district_id">
                                                        <select name="district_id" class="form-control single-select2"
                                                            required>
                                                            <option value="">{{ __('login_register.district') }} *
                                                            </option>
                                                    ...
                                                    <div class="mb-3 col-sm-12">
                                                        <input type="Password" name="password_confirmation"
                                                            class="form-control"
                                                            placeholder="{{ __('login_register.rePassword') }}  *"
                                                            required>
                                                    ...
                                                    <div class="col-sm-12 d-grid">
                                                        <button type="submit"
                                                            class="btn btn-primary">{{ __('login_register.registerBtn') }}
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        <div class="widget widget-course-instructor">
                            ...
                            <div class="col-sm-4">
                                ...
                                <ul class="d-flex mb-0 list-unstyled mt-2">
                                    ...
                                    <li><a class="btn btn-outline-primary-hover btn-sm py-1 px-2 mx-1"
                                            href="#">{{ $courseCount }}
                                            Courses</a></li>
