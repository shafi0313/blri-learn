                        ...
                        <div class="card-body">
                            ...
                            @if ($courseEnroll->status != 1 || empty($courseEnroll))
                                ...
                                <form action="{{ route('user.lecture.lectureComplete') }}" method="post">
                                    @csrf
                                    <input type="hidden" name="course_id" class="form-control" value="{{ $lecturePlay->course_id }}">
                                    <input type="hidden" name="lecture_id" class="form-control" value="{{ $lecturePlay->id }}">
