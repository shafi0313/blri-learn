        ...
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                <li class="nav-section">
                    ...
                    <h4 class="text-section">{{__('global.userComponents')}}</h4>
                </li>

                <li class="nav-item {{$m=='myCourse'?'active':''}}">
                    <a href="{{ route('user.myCourse.index') }}">
                        <i class="fas fa-swatchbook"></i>
                        <p>{{__('global.userMyCourse')}}</p>
                    </a>
                </li>

                <li class="nav-item {{$m=='myProfile'?'active':''}}">
                    <a href="{{ route('user.myProfile.edit') }}">
                        <i class="fas fa-user-circle"></i>
                        <p>{{__('global.userProfile')}}</p>
                    </a>
                </li>

                <li class="nav-item {{$m=='certificate'?'active':''}}">
                    <a href="{{ route('user.certificate.index') }}">
                        <i class="fas fa-book-open"></i>
                        <p>{{__('global.userCertificate')}}</p>
                    </a>
                </li>
